...
require "renren/parse"

require 'pp'

describe Renren::Parse do

  describe "handle return from users_getLoggedInUser_response" do
    it "should return the user id" do
      result = Renren::Parse.new.process(users_get_logged_in_user_response_xml)
  ...
  describe "handle return from profile_getXNML_response" do
    it "should return an array with a string" do
      pending "Until Renren fixs their XML"
      result = Renren::Parse.new.process(profile_get_xnml_response_xml)
      pp result.inspect
    end
  end
  ...
  describe "handle return from profile_setXNML_response" do
    it "should return a string" do
      result = Renren::Parse.new.process(profile_set_xnml_response_xml)
      result.should eql("1")
    end
  end
  ...
  describe "handle return from profile_setXNML_response" do
    it "should return nil" do
      result = Renren::Parse.new.process(empty_profile_set_xnml_response_xml)
      result.should eql([])
    end
  end
  ...
  describe "Handle error_response" do
    it "should return an Error on error_response" do
      result = Renren::Parse.new.process(error_response_xml)
      result.class.name.should == "Renren::Error"
  ...
  describe "Handle users_getInfo_response with new empty attr" do
    it "should return an array of User" do
      result = Renren::Parse.new.process(users_get_info_response_with_new_empty_attr_xml)
      result.should be_a_kind_of(Array)
      result.size.should == 1
      result.first.should be_a_kind_of(Renren::User)
  ...
  describe "Handle users_getInfo_response with new attr" do
    it "should return an array of User" do
      result = Renren::Parse.new.process(users_get_info_response_with_new_attr_xml)
      result.should be_a_kind_of(Array)
      result.size.should == 1
      result.first.should be_a_kind_of(Renren::User)
      result.first.uid.should eql("8055")
  ...
  describe "Handle users_getInfo_response with work history" do
    it "should return an array of User" do
      result = Renren::Parse.new.process(users_get_info_response_work_history_xml)
      result.should be_a_kind_of(Array)
      result.size.should == 1
    end
  end
  ...
  describe "Handle users_getInfo_response" do
    it "should return an array of User" do
      result = Renren::Parse.new.process(users_get_info_response_xml)
      result.should be_a_kind_of(Array)
      result.size.should == 1
    end
  end
  ...
  describe "Handle friends_getFriends_response" do
    it "should return an array of User" do
      result = Renren::Parse.new.process(friends_get_friends_response_xml)
      result.should be_a_kind_of(Array)
  ...
  describe "blog_gets_response" do
    it "should return an array of blogs" do
      result = Renren::Parse.new.process(blog_gets_response_xml)
      result.should be_a_kind_of(Array)
  ...
  describe "requests_get_guest_requests_response" do
    it "should return an array of guests" do
      result = Renren::Parse.new.process(requests_get_guest_requests_response_xml)
      result.should be_a_kind_of(Array)
  ...
  describe "requests_get_pokes_response" do
    it "should return an array of pokes" do
      result = Renren::Parse.new.process(requests_get_pokes_response_xml)
      result.should be_a_kind_of(Array)
      result.size.should eql(1)
    end
    
    it "should return an array of pokes" do
      result = Renren::Parse.new.process(requests_get_pokes_response_cdata_xml)
      result.should be_a_kind_of(Array)
      result.size.should eql(1)
  ...
  describe "wall_get_posts_response" do
    it "should return an array of comments" do
      result = Renren::Parse.new.process(wall_get_posts_response_xml)
  ...
  describe "wall_add_post_response" do
    it "should return an WallPost with id" do
      result = Renren::Parse.new.process(wall_add_post_response_xml)
  ...
  describe "friends_getAppUsers_response" do
    it "should return an array of User" do
      result = Renren::Parse.new.process(friends_get_app_users_response_xml)
      result.size.should eql(2)
    ...
    it "should return an empty array" do
      result = Renren::Parse.new.process(empty_friends_get_app_users_response_xml)
  ...
  describe "requests_sendRequest_response" do
    it "should return an array of User" do
      result = Renren::Parse.new.process(requests_send_request_response_xml)
      result.size.should eql(2)
  ...
  describe "auth_getSession_response" do
    it "should return a session_key" do 
      result = Renren::Parse.new.process(auth_get_session_response_xml)
  ...
  def auth_get_session_response_xml
    <<-XML
      ...
      <auth_getSession_response 
         xmlns="http://api.renren.com/1.0/" 
         xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" 
         xsi:SchemaLocation="http://api.renren.com/1.0/renren.xsd">
  ...
  def requests_send_request_response_xml
    <<-XML
      <?xml version="1.0" encoding="UTF-8"?>
      <requests_sendRequest_response xmlns="http://api.renren.com/1.0/"
	                             xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
...
<wall_getPosts_response>
  ...
  <comments list="true">
    <comment>
      ...
      <tinyurl>http://head.renren.com/photos/20070616/13/37/tiny36939.jpg</tinyurl>
    ...
    <comment>
      ...
      <tinyurl>http://hd27.renren.com/photos/hd27/20080611/16/33/tiny_3207h169.jpg</tinyurl>
    ...
    <comment>
      ...
      <tinyurl>http://hd51.renren.com/photos/hd51/20080504/00/09/tiny_10137n107.jpg</tinyurl>
      <text>回复sophia：\n\nhttp://group.renren.com/GetThread.do?id=326001767&amp;amp;curpage=0&amp;amp;parentpage=0&amp;amp;tribeId=237768885</text>
    </comment>
    <comment>
      <id>2465025685</id>
      <uid>238943997</uid>
    ...
    <comment>
      ...
      <tinyurl>http://hd51.renren.com/photos/hd51/20080609/15/47/tiny_4301p169.jpg</tinyurl>
    ...
    <comment>
      ...
      <tinyurl>http://hd15.renren.com/photos/hd15/20080603/23/19/tiny_6320f107.jpg</tinyurl>
...
<requests_getGuestRequests_response list="true">
  <total>1</total>
  <guest>
    <headurl>http://head.renren.com/photos/0/0/head.jpg</headurl>
    <uid>246353875</uid>
    <name>李大维</name>
    <network>上海市</network>
  </guest>
...
XML
  ...
  <album>
    <aid>242570156</aid>
    <uid>243357028</uid>
    <url>http://fm481.img.renren.com/pic001/20080509/21/58/main_5827e70.jpg</url>
    <name>人像</name>
    <size>2</size>
...
<users_getInfo_response list="true">
  <user>
    ...
    <tinyurl>http://head.renren.com/photos/tiny_10942g177.jpg</tinyurl>
    <headurl>http://head.renren.com/photos/tiny_10942g177.jpg</headurl>
    <mainurl>http://head.renren.com/photos/tiny_10942g177.jpg</mainurl>
    <hometown_location>
      <country>中国</country>
    ...
    <contact_info>
      ...
      <web_site>http://www.renren.com/getuser.do?id=123</web_site>
    </contact_info>
...
<friends_getFriends_response list="true">
  ...
  <friend>
    <id>10131</id>
    <name>梁栋</name>
    <headurl>http://hd22.renren.com/photos/hd22/20071123/23/30/head_7076k107.jpg</headurl>
  ...
  <friend>
    <id>68126</id>
    <name>赵宁</name>
    <headurl>http://head.renren.com/photos/68/126/head40358.jpg</headurl>
  ...
  <friend>
    <id>28094875</id>
    <name>王渊命</name>
    <headurl>http://head.renren.com/photos/20070624/22/07/head_3612f56.jpg</headurl>
  ...
  <friend>
    <id>28650033</id>
    <name>杜子兮</name>
    <headurl>http://hd52.renren.com/photos/hd52/20080606/02/06/head_7583c107.jpg</headurl>
  ...
  <friend>
    <id>39588524</id>
    <name>梁公军</name>
    <headurl>http://hd14.renren.com/photos/hd14/20080425/00/16/head_5179l150.jpg</headurl>
    <network_id>60001001</network_id>
    <network_name>北京市</network_name>
  </friend>
  <friend>
    <id>48792716</id>
    <name>冯浩♥China</name>
    <headurl>http://hd27.renren.com/photos/hd27/20080523/17/00/head_6159k150.jpg</headurl>
  ...
  <friend>
    <id>50030891</id>
    <name>焦跃</name>
    <headurl>http://hd20.renren.com/photos/hd20/20070722/00/14/head_10591a72.jpg</headurl>
  ...
  <friend>
    <id>52277711</id>
    <name>张志强</name>
    <headurl>http://hd34.renren.com/photos/hd34/20080423/21/43/head_5947l107.jpg</headurl>
  ...
  <friend>
    <id>53480507</id>
    <name>高山</name>
    <headurl>http://hd25.renren.com/photos/hd25/20080310/22/47/head_9045m169.jpg</headurl>
  ...
  <friend>
    <id>63437474</id>
    <name>王琦bakin</name>
    <headurl>http://hd22.renren.com/photos/hd22/20071129/16/01/head_4493o107.jpg</headurl>
  ...
  <friend>
    <id>78953558</id>
    <name>小怒</name>
    <headurl>http://hd51.renren.com/photos/hd51/20080520/14/49/head_2999m150.jpg</headurl>
  ...
  <friend>
    <id>80288196</id>
    <name>江云帆</name>
    <headurl>http://hd33.renren.com/photos/hd33/20080205/12/55/head_1436h169.jpg</headurl>
  ...
  <friend>
    <id>85432256</id>
    <name>黄晶</name>
    <headurl>http://hd34.renren.com/photos/hd34/20080522/10/06/head_587n150.jpg</headurl>
  ...
  <friend>
    <id>143430531</id>
    <name>孙雪峰</name>
    <headurl>http://hd14.renren.com/photos/hd14/20080505/09/30/head_489k107.jpg</headurl>
  ...
  <friend>
    <id>148834358</id>
    <name>杨智强Andy</name>
    <headurl>http://hd15.renren.com/photos/hd15/20080526/13/16/head_1866i169.jpg</headurl>
  ...
  <friend>
    <id>164613341</id>
    <name>蒋洁</name>
    <headurl>http://hd15.renren.com/photos/hd15/20080602/19/24/head_5039c150.jpg</headurl>
  ...
  <friend>
    <id>192248596</id>
    <name>lzz∮┟</name>
    <headurl>http://hd52.renren.com/photos/hd52/20080605/17/11/head_3574c107.jpg</headurl>
  ...
  <friend>
    <id>200000108</id>
    <name>唐炜</name>
    <headurl>http://hd27.renren.com/photos/hd27/20080523/13/23/head_3175n107.jpg</headurl>
    <network_id>20001001</network_id>
    <network_name>千橡互动</network_name>
  </friend>
  <friend>
    <id>200000548</id>
    <name>蒲忠杰</name>
    <headurl>http://head.renren.com/photos/20070411/0950/head55914.jpg</headurl>
    <network_id>60001001</network_id>
    <network_name>北京市</network_name>
  </friend>
  <friend>
    <id>200003551</id>
    <name>张洪波</name>
    <headurl>http://hd51.renren.com/photos/hd51/20080602/14/57/head_2734a150.jpg</headurl>
