    ...
    module Routing
      module RouteSetExtensions
        def self.included(base)
          base.alias_method_chain :extract_request_environment, :xiaonei
        end

        def extract_request_environment_with_xiaonei(request)
          env = extract_request_environment_without_xiaonei(request)
      ...
      module MapperExtensions
        ...
        #
        # Example: 
        #   map.xiaonei_resources :profiles
        #
        ...
        #
        def xiaonei_resources(name_sym)
          name = name_sym.to_s
